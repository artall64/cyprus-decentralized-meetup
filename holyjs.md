...
## • 900K пользователей, обмены на $360M в день 
...
## • [Пример](https://etherscan.io/tx/0x326d3e0de9a5203df1479dc126867bcc5875a7d6e5451921920aa9bb1ad4b063) транзакции - вызова метода контракта, комиссия сети $179 за computation
---

## Поэтому для демо будем использовать `Binance Smart Chain`
## • [Пример](https://bscscan.com/tx/0x832709e841a4844a1b7f2ced73dc9c853b0a8c1071f71d5d3336aea52b7df9d9) транзакции - комиссия сети ($0.48 за computation
---
...
---
![alt going-depper.png](images/deepper.png)
...
---
# Контракты - обменники (AMM или Liqudity Pool)
...
## • [Web3](https://web3js.readthedocs.io/), [Ethers](https://docs.ethers.io/)
## • [EIP-20](https://eips.ethereum.org/EIPS/eip-20)
## • [ERC-20](https://ethereum.org/ru/developers/docs/standards/tokenspdf)

---
## Полезные ссылки
## • [1inch.io](http://1inch.io/) - 1inch Network
## • [Programming Bitcoin](https://www.amazon.co.uk/Programming-Bitcoin-Learn-Program-Scratch/dp/1492031496) - книжка для тех кто решил разобраться как следует
...
---
## ![alt cant-justpng](images/see-you.png)
